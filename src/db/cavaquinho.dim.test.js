...
describe('cavaquinho dim source golden', () => {
  Object.keys(sourcePositions).map((key) => {
    ...
    chord.positions.map((position, index) => {
      ...
      it(`${key}dim position ${positionNumber} should match the source transcription`, () =>
        expect(positionSnapshot(position)).toEqual(expectedSnapshot(expected)));

      it(`${key}dim position ${positionNumber} should contain only diminished-seventh tones`, () =>
        expectOnlyChordTones(position, tones));

      it(`${key}dim position ${positionNumber} should satisfy cavaquinho data invariants`, () =>
    ...
    chord.positions.map((position, index) => {
      ...
      if (openPositions.includes(positionNumber)) {
        it(`${key}dim position ${positionNumber} should preserve source open-register semantics`, () => {
      ...
      it(`${key}dim position ${positionNumber} should preserve source closed-barre semantics`, () =>
